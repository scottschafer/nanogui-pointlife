...
//
//CreatureConstructor :: CreatureConstructor(WorldData & world, Genome & genome) : mWorldData(world), mGenome(genome) {
//    mIndex = 0;
//    mNumCells = 0;
//    
//    mTurns = 0;
...
//}
//
//CreatureConstructor :: CreatureConstructor(WorldData & world, const char ** asciArt) :
//mWorldData(world), mAsciArt(asciArt), mGenome(* new Genome()) {
//    mIndex = 0;
//    mNumCells = 0;
//    mGenome.randomize();
//    
...
//    
//    WorldSpace &wp = mWorldData.getWorldSpace();
//    
...
//    }
//    
//    Cell * pResult = mWorldData.addCell(x, y);
//    if (pResult) {
...
//        }
//        pResult->mEntityHead = &mWorldData.mCells[mEntityIndex];
//        
...
//                
//            default: {
//                Cell & a = mWorldData.mCells[iCellA];
//                Cell & b = mWorldData.mCells[iCellB];
//                
